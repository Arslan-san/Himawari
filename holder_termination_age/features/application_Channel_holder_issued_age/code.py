...
select i."Policy Type Name", j."a_group",i."Policyholder'S_Gender","application Channel",
...
group by i."Policy Type Name", j."a_group",i."Policyholder'S_Gender","application Channel"
order by i."Policy Type Name", j."a_group",i."Policyholder'S_Gender","application Channel"
 """
