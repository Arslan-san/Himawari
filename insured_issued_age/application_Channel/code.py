...
select i."Policy Type Name", j."a_group",i."Insured'S Gender","application Channel","application_detail" as "detail",
...
group by i."Policy Type Name", j."a_group",i."Insured'S Gender","application Channel","application_detail"
order by i."Policy Type Name", j."a_group",i."Insured'S Gender","application Channel","application_detail"
