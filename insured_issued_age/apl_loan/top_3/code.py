...
select i."Policy Type Name", j."a_group",i."Insured'S Gender",split_part("APL Number of LOAN",'.',1)::int as "APL Number of LOAN",count(*)
...
group by i."Policy Type Name", j."a_group",i."Insured'S Gender",split_part("APL Number of LOAN",'.',1)::int
order by i."Policy Type Name", j."a_group",i."Insured'S Gender",split_part("APL Number of LOAN",'.',1)::int
