...
select i."Policy Type Name", j."a_group",i."Insured'S Gender",i."Termination  Reason",i."merge_reason_code",i."Type",i."Details",
...
group by i."Policy Type Name", j."a_group",i."Insured'S Gender",i."Termination  Reason",i."merge_reason_code",i."Type",i."Details"
order by i."Policy Type Name", j."a_group",i."Insured'S Gender",i."Termination  Reason",i."merge_reason_code",i."Type",i."Details"
