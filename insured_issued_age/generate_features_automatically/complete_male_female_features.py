...
gender = list(data_channel["Insured'S Gender"].unique())
gender = [1,2]
...
for g in gender:
    ...
    for i in products:    
        for j in ages:
                ...
                total_P = data_P[(data_P['Policy Type Name'] == i) & (data_P['a_group'] == j) & (data_P["Insured'S Gender"] == g)][['LatestP_01 SUM']]
                
                total_P_avg = data_P[(data_P['Policy Type Name'] == i) & (data_P['a_group'] == j) & (data_P["Insured'S Gender"] == g)][['LatestP_01 average']]
                ...
                total_S = data_S[(data_S['Policy Type Name'] == i) & (data_S['a_group'] == j) & (data_S["Insured'S Gender"] == g)][['LatestS_01 SUM']]
                            
                total_S_avg = data_S[(data_S['Policy Type Name'] == i) & (data_S['a_group'] == j) & (data_S["Insured'S Gender"] == g)][['LatestS_01 average']]
                ...
                average_duration = data_insurance_duration[(data_insurance_duration['Policy Type Name'] == i) & (data_insurance_duration['a_group'] == j) & (data_insurance_duration["Insured'S Gender"] == g)][['average']]
                ...
                charge = extrta_charge[(extrta_charge['Policy Type Name'] == i) & (extrta_charge['a_group'] == j) & (extrta_charge["Insured'S Gender"] == g)][['count']]
                ...
                channel = data_channel[(data_channel['Policy Type Name'] == i) & (data_channel['a_group'] == j) & (data_channel["Insured'S Gender"] ==g)]#[['application Channel Count']]
                channel = channel.dropna(axis=0, how='any')               
                channel = channel.nlargest(3, 'application Channel Count')
    
                reason = data_t_reason[(data_t_reason['Policy Type Name'] == i) & (data_t_reason['a_group'] == j) & (data_t_reason["Insured'S Gender"] == g)]#[['application Channel Count']]
                reason = reason.dropna(axis=0, how='any')               
                reason = reason.nlargest(3, 'Termination Reason  Count')
    
                address_count = address[(address['Policy Type Name'] == i) & (address['a_group'] == j) & (address["Insured'S Gender"] == g)]#[['application Channel Count']]
                address_count = address_count.dropna(axis=0, how='any')               
                address_count = address_count.nlargest(3, 'address Count')
                
                top_3_count = apl_count[(apl_count['Policy Type Name'] == i) & (apl_count['a_group'] == j) & (apl_count["Insured'S Gender"] == g)]
