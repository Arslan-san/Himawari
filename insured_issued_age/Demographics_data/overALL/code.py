...
select j."a_group",i."Insured'S Gender",count(*) 
...
where i."Insured'S Gender" not in ('0','3')
group by j."a_group",i."Insured'S Gender"
order by j."a_group",i."Insured'S Gender"
