...
select i."Policy Type Name", j."a_group",i."Policyholder'S_Gender",
     count(split_part(i."LatestP_01",'.',1)::int)as "LatestP_01 Count",
     sum(split_part(i."LatestP_01",'.',1)::int) as "LatestP_01 SUM",
     avg(split_part(i."LatestP_01",'.',1)::int) as "LatestP_01 average"  
...
--where i."Termination  Reason" is not NULL and i."Type" = 'Surrender ' -- and i."Policy Type Name" = 'Whole life'
...
#%%
query_data.to_csv('Lates_P.csv',index=False)
