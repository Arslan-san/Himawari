...
csv = ['only_t','total_t']
terminated_and_total = ['\"Termination  Reason" is not NULL and "Type" = ' + """ 'Surrender ' and """ ,'']
        ...
        for j in range(len(gender)):
            if i != len(age)-1:
                ...
                (
                	...
                	(
                		select * from "pi_ph_seg_seg2_seg3_holder_new"
                		where """ + terminated_and_total[k] + """  EXTRACT(YEAR FROM "holder_age")::int >= """ + str(min_age) + """
                		and EXTRACT(YEAR FROM "holder_age")::int <= """ + str(max_age) + """
                ...
                (
                	...
                	(
                		...
                		where """ + terminated_and_total[k] + """
                         EXTRACT(YEAR FROM "holder_age")::int > """ + str(64) + """
                		and "Policyholder'S_Gender" = """ + """'""" + str(gender[j]) + """'""" +  """
                	)as q group by q."LatestPolicyType_01",q."Policy Type Name"
