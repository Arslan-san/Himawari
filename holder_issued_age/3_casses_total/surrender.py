# -*- coding: utf-8 -*-
"""
Created on Tue Mar 20 03:11:51 2018
...
where "Type" = 'Surrender ' and (i."Policyholder'S_Gender" != '3' or i."Policyholder'S_Gender" = '0')
...
#%%
query_data.to_csv('surrender.csv',index=False)