...
query = """ 
	...
	where i."Policy Type Name" = 'Whole life' and 'Terminatin  Reason' is not NULL and "Type" = 'Surrender '
...
#%%
whole_life.to_csv('whole_life_terminated_surrender_stats.csv',index=False)
